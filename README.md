...
- Как верифицировать и валидировать сами тесты? (Permutation testing)
...
- Раннеры
- Пареллелизация тестового набора
- Автотестирование Swing UI _в CI_
